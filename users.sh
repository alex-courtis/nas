...
groupadd -g 1100 media ; useradd -M -s /sbin/nologin -d / -u 1100 -g 1100 media
...
groupadd -g 1105 scratch ; useradd -M -s /sbin/nologin -d / -u 1105 -g 1105 scratch
...
usermod -a -G media,music,download,tv,movie,scratch,save,archive ${USER}
